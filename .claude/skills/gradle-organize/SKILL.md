...
When you change section headers or catalog layout here, also update `gradle-update`, `setup-new-project` / `setup-old-project` Gradle steps, `08-gradle` + `reference/gradle.md`, and `.cursor` twins.
