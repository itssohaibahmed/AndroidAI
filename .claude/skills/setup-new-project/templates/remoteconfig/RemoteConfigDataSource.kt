 ...
 *
 * Requires `kotlinx-coroutines-play-services` (`Task.await()`) on `:data`.
 * Live listener registration (`listenerRegistered`) lives in `RemoteConfigRepositoryImpl`,
 * which calls [addConfigUpdateListener] — do not register the listener twice in this class.
 */
