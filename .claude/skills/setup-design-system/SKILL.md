...
Follow `.claude/rules/` — especially `09-resources-xml` + [reference/resources-xml.md](../../rules/reference/resources-xml.md), `12-naming-conventions`, `24-figma-assets`, `00-global`.

Obey `.claude/project-settings.json` when present (`themeModes`, `orientation`, `applicationId`, optional `figmaDesignSystemUrl`).
