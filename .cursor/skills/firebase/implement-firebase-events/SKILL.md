...
2. Add `fun String.postFirebaseEvent()` to existing `PlatformFirebase` (`:core-platform`). Create the `object` only if missing — no `Context`, no ads-revenue helper in this skill
